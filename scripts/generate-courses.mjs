...
const RUBRICS = [
  ...
  },
  {
    ...
    max: 8,
    criteria: [
      { key: "runs_from_clean", label: "Runs from a clean clone with the documented steps", weight: 3, check: "peer", checker: null },
      { key: "does_what_it_claims", label: "Does what the README says it does", weight: 3, check: "peer", checker: null },
      { key: "readable", label: "A reviewer can find where a change would go", weight: 2, check: "peer", checker: null },
    ],
  },
  {
    ...
    max: 7,
    criteria: [
      { key: "documented", label: "Every endpoint documented with request and response", weight: 2, check: "peer", checker: null },
      { key: "status_codes", label: "Correct status codes, including the failure cases", weight: 3, check: "peer", checker: null },
      { key: "validation", label: "Rejects bad input instead of storing it", weight: 2, check: "peer", checker: null },
    ],
  },
  {
    name: "test-suite-v1",
    max: 6,
    criteria: [
      { key: "covers_failure", label: "Tests the failure paths, not only the happy one", weight: 3, check: "peer", checker: null },
      { key: "deterministic", label: "Passes twice in a row without edits", weight: 2, check: "peer", checker: null },
      { key: "readable", label: "A failure message says what broke", weight: 1, check: "peer", checker: null },
    ],
  },
  {
    name: "walkthrough-v1",
