    ...
    <div aria-busy className="flex h-dvh flex-col bg-white lg:bg-ink-50">
      ...
      <div className="min-h-0 flex-1 overflow-hidden">
        <div className="mx-auto max-w-[720px]">
          <div className="min-h-full bg-white px-5 pt-5 lg:border-x lg:border-ink-100">
