...
export function getPublicEnv() {
  ...
  throw new Error(
    [
      ...
      ...lines,
      "",
      "Fix: copy .env.example to .env.local and fill in the two values from",
      "your Supabase project under Settings > API (Project URL and the anon",
      "public key), then restart the dev server — Next reads .env.local once",
      "at boot.",
      "",
