/**
 * The glyph beside a roadmap resource.
 *
 * The kind union mirrors resources.type in the schema (0002_roadmaps.sql);
 * the reader screen that consumes this arrives in the next phase.
 *
 ...
 */
export type ResourceKind = "read" | "video" | "doc" | "case_study" | "tool" | "latest";

const PATHS: Record<ResourceKind, React.ReactNode> = {
  video: (
    <>
